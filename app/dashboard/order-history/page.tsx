...
import { downloadOrderPDF, downloadOrdersPDF, openOrderPDF } from '@/lib/pdf';
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <button
                          ...
                          className="text-left flex items-center mr-3"
                        >
                          ...
                          <svg 
                            className={`ml-2 h-5 w-5 text-gray-400 transform ${expandedOrder === order.id ? 'rotate-180' : ''}`} 
                      ...
                      <div className="flex space-x-2">
                        <button 
                          ...
                          className="text-sm py-1 px-2.5 border border-blue-300 text-blue-700 rounded-md hover:bg-blue-50 flex items-center"
                          title="PDF 다운로드"
                        >
                        ...
                        <button 
                          ...
                          className="text-sm py-1 px-2.5 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 flex items-center"
                          title="새 탭에서 PDF 보기"
                        >
                          <svg className="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
