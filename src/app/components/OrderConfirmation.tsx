...
export default function OrderConfirmation({ orders }: OrderConfirmationProps) {
  return (
    <>
              ...
              <tr key={o.regid} style={{textAlign:'center',color:'#333'}}>
                ...
                <td style={{border:'1px solid #bcbcbc',padding:'6px 0'}}>
                  <div style={{display:'flex',justifyContent:'center',gap:5}}>
                    <button style={{background:'#4caf50',color:'white',border:'none',borderRadius:4,padding:'3px 8px',fontSize:13}}>승인</button>
                    <button style={{background:'#f44336',color:'white',border:'none',borderRadius:4,padding:'3px 8px',fontSize:13}}>반려</button>
                  </div>
                </td>
              </tr>
            ))}
